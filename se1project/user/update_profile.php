...
// 	if(isset($_POST['username']))
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$zipcode=$_POST['zipcode'];
       	...
       	$sql ="UPDATE user_login set  firstname='$fname', lastname='$lname', contactno='$mobileNumber', streetaddress='$streetAddress', zipcode='$zipcode', email='$email' where username='$userName'";
